...
interface FractionInterface {
   ...
   * @param string $separator
   *   The character that should be used as a decimal separator. If this is not
   *   set, then the default separator will be a period.
   *
   * @return string
   *   Returns the decimal equivalent of the fraction as a PHP string.
   */
  public function toDecimal(int $precision, bool $auto_precision = FALSE, string $separator = NULL);
